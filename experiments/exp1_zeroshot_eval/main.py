...
INPUT_FILE = [
    RESULTS_ROOT / "exp1_zeroshot" / "gptoss" / "R05_exp1_results_gptoss.json",
    RESULTS_ROOT / "exp1_zeroshot" / "llama4" / "R05_exp1_results_llama4.json",
    RESULTS_ROOT / "exp1_zeroshot" / "gptoss" / "R06_exp1_results_gptoss.json",
    RESULTS_ROOT / "exp1_zeroshot" / "llama4" / "R06_exp1_results_llama4.json",
]

# 既存の OUTPUT_FILE を「JSONL」に置き換える（拡張子だけ変える）
OUTPUT_FILE = [
    RESULTS_ROOT / "exp1_zeroshot_eval" / "gptoss" / "R05_exp1_eval_gptoss.jsonl",
    RESULTS_ROOT / "exp1_zeroshot_eval" / "llama4" / "R05_exp1_eval_llama4.jsonl",
    RESULTS_ROOT / "exp1_zeroshot_eval" / "gptoss" / "R06_exp1_eval_gptoss.jsonl",
    RESULTS_ROOT / "exp1_zeroshot_eval" / "llama4" / "R06_exp1_eval_llama4.jsonl",
]
